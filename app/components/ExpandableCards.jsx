              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-full font-bold bg-navy text-white"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold hover:bg-navy text-white hover:text-whit mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
...
const cards = [
  {
    ...
    content: () => {
      return (
        <p>
          This project involves a machine learning model to accurately identify
          and classify objects in images.This can be used for various
          applications such as facial recognition, medical image analysis,and
          self-driving cars.
        </p>
      );
    },
